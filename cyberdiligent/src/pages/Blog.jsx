  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "In today's data-driven world, organizations across industries increasingly recognize the critical importance of data quality in driving successful business outcomes.",
      image:
        "https://storage.googleapis.com/a1aa/image/d82c7494-b430-4f42-a204-9cf6e2661606.jpg",
    ...
    },
    {
      ...
      excerpt:
        "We delve into the intricacies of the Diamond Model for Intrusion Analysis, a structured framework essential for understanding cybersecurity threats.",
      image:
        "https://storage.googleapis.com/a1aa/image/fdbfc33b-4595-46be-ef0a-2a8be888b2cf.jpg",
      author: "Russell Okoth",
      date: "4/21/2024",
    },
    {
      ...
      excerpt:
        "The significance of Critical Security Controls (CSC) developed by the Center for Internet Security (CIS) in addressing cybersecurity challenges.",
      image:
        "https://storage.googleapis.com/a1aa/image/47c51786-6ff7-4555-da16-aac5d49b6f60.jpg",
      author: "Russell Okoth",
      date: "2/23/2024",
    },
    {
      ...
      excerpt:
        "Drawing parallels between cycling dynamics and the life of a CISO for insights into managing cybersecurity while serving business needs.",
      image:
        "https://storage.googleapis.com/a1aa/image/61af45d0-c5d0-476b-a2c7-40d98ea9526d.jpg",
      author: "Russell Okoth",
      date: "10/20/2023",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-white dark:from-gray-900 dark:to-teal-900 text-gray-900 font-sans p-6 md:p-12">
      ...
      >
        ...
        <p className="text-lg dark:text-gray-50 max-w-3xl mx-auto leading-relaxed">
          Stay informed with our latest articles, research, and perspectives on
          cybersecurity strategy, AI governance, and emerging threats.
        </p>
      </motion.div>
      ...
      {carouselPage === 1 && (
        ...
        >
          ...
          <h2 className="text-3xl font-extrabold text-gray-800 dark:text-gray-50 mb-8">
            Featured Articles
          </h2>
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <p
          className={`text-gray-600 mb-4 ${featured ? "text-base" : "text-sm"}`}
        >
          {excerpt}
        </p>
