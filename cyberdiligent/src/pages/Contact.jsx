...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-white text-gray-800 font-sans px-6 py-16">
      {" "}
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
